 ...
 */
final class Version20220301191641 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payment (id INT NOT NULL, my_account_id INT NOT NULL, payer_user_id INT NOT NULL, owner_id INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, status INT NOT NULL, amount INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE virement DROP status');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE virement ADD status INT NOT NULL');
    }
}
